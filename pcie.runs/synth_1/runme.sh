...
HD_PWD='/home/alexey101/vivado_prj/pcie/pcie.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcie_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcie_wrapper.tcl
