...
HD_PWD='/home/alexey101/vivado_prj/pcie/pcie.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pcie_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pcie_wrapper.tcl -notrace
