...
HD_PWD='/home/alexey101/vivado_prj/pcie/pcie.runs/pcie_util_ds_buf_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcie_util_ds_buf_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcie_util_ds_buf_0_0.tcl
