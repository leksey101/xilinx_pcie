...
HD_PWD='/home/alexey101/vivado_prj/pcie/pcie.runs/pcie_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcie_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcie_auto_pc_0.tcl
