...
HD_PWD='/home/alexey101/vivado_prj/pcie/pcie.runs/pcie_proc_sys_reset_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcie_proc_sys_reset_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcie_proc_sys_reset_1_0.tcl
